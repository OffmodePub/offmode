...
| 항목 | 값 | 출처 |
|---|---|---|
| iOS Bundle ID | `com.minnnj.offmode` | `app.json:15`, `ios/offmode/Info.plist` |
...
| 백엔드 Apple issuer | `https://appleid.apple.com` | `application.yml:25` |
| 백엔드 Kakao userinfo | `https://kapi.kakao.com/v2/user/me` | `application.yml:19` |
